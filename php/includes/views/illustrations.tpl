<!DOCTYPE html>
<html lang="en">
<head> <title>Illustrations - yourssocially.in</title>
  ...
  <div id="main">
    ...
    <section id="content">
    	<div class="indent">
          ...
          <li><a href="#" class="current">ILLUSTRATIONS</a></li>
        </ul>
        <div class="anythingSlider">
          <div class="wrapper">
            <ul class="slides">
              <li>
              	<figure class="preview"><img src="/static/images/illustration_img1.jpg" alt=""></figure>
                <ul class="project-info">
                	<li><strong class="name">Project:</strong> Illustration for a book</li>
                  <li><strong class="name">Client:</strong> Melisa Meade</li>
                  <li><strong class="name">Description:</strong> The client needed soft, soothing coloured sketches, and we put in our hearts and souls to create this one. Needless to say, she was elated!  </li>
                </ul>
              </li>
              <li>
              	<figure class="preview"><img src="/static/images/illustration_img2.jpg" alt=""></figure>
                <ul class="project-info">
                	<li><strong class="name">Project:</strong>  Illustration for a book</li>
                  <li><strong class="name">Client:</strong> Melisa Meade</li>
                  <li><strong class="name">Description:</strong> The client needed soft, soothing coloured sketches, and we put in our hearts and souls to create this one. Needless to say, she was elated!  </li>
              ...
              <li>
              	<figure class="preview"><img src="/static/images/illustration_img3.jpg" alt=""></figure>
                <ul class="project-info">
                	<li><strong class="name">Project:</strong>  Illustration for a book</li>
                  <li><strong class="name">Client:</strong> Melisa Meade</li>
                  <li><strong class="name">Description:</strong> The client needed soft, soothing coloured sketches, and we put in our hearts and souls to create this one. Needless to say, she was elated!  </li>
              ...
              <li>
              	<figure class="preview"><img src="/static/images/illustration_img4.jpg" alt=""></figure>
                <ul class="project-info">
                	<li><strong class="name">Project:</strong>  Illustration for a book</li>
                  <li><strong class="name">Client:</strong> Melisa Meade</li>
                  <li><strong class="name">Description:</strong> The client needed soft, soothing coloured sketches, and we put in our hearts and souls to create this one. Needless to say, she was elated! </li>
